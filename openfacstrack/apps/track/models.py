...
class Patient(TimeStampedModel) :
  ...
  def __str__(self):
    return ", ".join(["CovidID:"+self.covid_patent_id, "Age: "+str(self.age), "Sex: "+self.sex])
...
class ProcessedSample(TimeStampedModel) :
  ...
  def __str__(self):
    return ", ".join(["Patient ID:" + self.patient.covid_patent_id, "Biobank ID:" + self.biobank_id,"Date acquired:"+str(self.date_acquired)])
...
class StoredSample(TimeStampedModel) :
  ...
  def __str__(self):
    return ", ".join(["Patient ID:" + self.processed_sample.patient.covid_patent_id, "Biobank ID:" + self.processed_sample.biobank_id, "Date acquired:"+self.date_acquired, "Stored Sample ID"+self.stored_sample_id])
...
class Parameter(TimeStampedModel) :
  ...
  def __str__(self):
    return ", ".join(["Panel name:" + self.panel.name, "Parameter:" + self.display_name, "Type: "+self.data_type, "Internal name:"+self.internal_name, "Excel column name:"+self.excel_column_name])
...
class DataProcessing(TimeStampedModel) :
  ...
  def __str__(self):
    return ", ".join(["Patient ID:" + self.processed_sample.patient.covid_patent_id, "Panel name:" + self.panel.name, "FCS file:"+self.fcs_file_name+ "(location: "+self.fcs_file_location+")"])
...
class NumericParameter(TimeStampedModel) :
  ...
  def __str__(self):
    return ", ".join(["Patient ID:" + self.processed_sample.patient.covid_patent_id, "Parameter:" + self.parameter.display_name, "Value:"+str(self.value)])
...
class TextParameter(TimeStampedModel) :
  ...
  def __str__(self):
    return ", ".join(["Patient ID:" + self.processed_sample.patient.covid_patent_id, "Parameter:" + self.parameter.display_name, "Value:"+self.value])
